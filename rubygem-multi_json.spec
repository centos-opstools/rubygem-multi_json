...
# We need source tarball, because from v1.11.1 test suite is not packaged in gem
# see: https://github.com/intridea/multi_json/issues/162
Source1:        https://github.com/intridea/multi_json/archive/v%{version}.tar.gz
...
# Copy test suite to gem dir
tar -xzf %{SOURCE1}
ls -l
mv %{gem_name}-%{version}/spec .%{gem_instdir}
rm -fr %{gem_name}-%{version}
...
%changelog
* Fri Sep 16 2016 Rich Megginson <rmeggins@redhat.com> - 1.12.1-1
- Updated to upstream version 1.12.1

* Tue Apr 12 2016 Martin Mágr <mmagr@redhat.com> -  1.11.2-2
- Added rubygem-yajl-ruby dependency (rhbz#1291793)

* Wed Feb 24 2016 Martin Mágr <mmagr@redhat.com> -  1.11.2-1
- Updated to upstream version 1.11.2
